...
object SnackBarHelper {
    ...
    fun noInternetOrLocationActive(activity: Activity, onClick: (() -> Unit)? = null, view: View = activity.container_layout) {
    ...
    fun offline(activity: Activity, view: View = activity.container_layout) {
